...
function () {
  ...
  Autoplay.prototype.init = function () {
    ...
    this.pausedOnSlideChange = false; // append autoplay controls
  ...
  Autoplay.prototype.controls = function () {
    ...
    var _html = "<button aria-label=\"" + this.settings.autoplayPluginStrings['toggleAutoplay'] + "\" type=\"button\" class=\"lg-autoplay-button lg-icon\"></button>"; // Append autoplay controls
...
/* harmony default export */ var lg_autoplay_es5 = (lg_autoplay_es5_Autoplay);
  ...
  if (galleries.length) {
    galleries.forEach(function (gallery) {
      lightgallery_es5(gallery, {
        plugins: [lg_zoom_es5, lg_video_es5, lg_autoplay_es5],
        speed: 400,
        autoplay: true,
